...
public class Util {
	...
	static public void setImages() {
		Image img1 = new Image(Main.class.getResource("").toString());
		Image img2 = new Image(Main.class.getResource("").toString());
		Image img3 = new Image(Main.class.getResource("").toString());
